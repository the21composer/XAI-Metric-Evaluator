...
import numpy as np
import json
import datasets_decorator as datasets
import metric_decorator as metric
import xai_methods_decorator as explainer
import model_decorator as model
import evaluator
import parse_utils
...
def process_args(args):
    if args.experiment_json:
        ...
        return evaluator.Experiment(dataset, models, explainers, metrics)
